...
object TodayFlagRegistry {
    ...
    private val fieldBindings = listOf(
        ...
        binding("AntOcean", "dailyOceanTask", patterns = listOf(exact(StatusFlags.FLAG_ANTOCEAN_TASKS_DONE), prefix(StatusFlags.FLAG_ANTOCEAN_ACTION_STOP_PREFIX))),
        binding("AntOcean", "aiFishEnable", "aiFishAutoTask", patterns = listOf(prefix(StatusFlags.FLAG_ANTOCEAN_AIFISH_ACTION_STOP_PREFIX))),
